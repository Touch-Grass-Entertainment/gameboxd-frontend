    ...
    return (
        <div className='flex flex-col mt-10'>
            <div className='flex items-center gap-2'>
                <span className='text-sm text-muted tracking-widest'>TOP RATED</span>
            ...
            <div className='flex flex-col gap-4 mt-2'>
                {games.results.map((game, i) => (
                    <div key={i} className='flex w-full gap-6 items-center bg-popover rounded-md py-4 px-6'>
                        ...
                        <img src={game.background_image} alt={game.name} className='size-20 rounded-md object-cover shrink-0' />
